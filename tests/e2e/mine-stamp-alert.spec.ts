...
test(
  "collecting a stamp pops a self-clearing alert with its art",
  ciCase("E2E-MINE-STAMP-ALERT-0001", "@functional"),
  async ({ page }) => {
...
test(
  "tapping a stamp alert opens the Stamp Book on that stamp",
  ciCase("E2E-MINE-STAMP-ALERT-0002", "@functional"),
  async ({ page }) => {
